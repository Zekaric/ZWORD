...
static Gfile *_FileOpen(Gpath const * const path)
{
   ...
   gpathPushExtensionA(pathFile, "html");
...
static Gb _FileWriteFormatHeader(Gfile * const file, Gs const * const title)
{
   ...
   if (title)
   {
      result |= gfileSetS(file, gcTypeU1, title, NULL);
   }
...
static Gb _FileWriteParagraph(Gfile * const file, Para const * const para)
{
   ...
   result &= gfileSetA(file, gcTypeU1, "<p class=\"zword\">", NULL);
   result &= gfileSetS(file, gcTypeU1, stemp,                 NULL);
   result &= gfileSetA(file, gcTypeU1, "</p>\n",              NULL);
   ...
   Gindex const indentLevel, ParaType const parentType)
{
   ...
   case paraTypeSCOPE_ITEM:
      ...
      case paraTypeSCOPE_LIST_NUMBER:
         result &= gfileSetA(file, gcTypeU1, "<li class=\"zword\">", NULL);
         break;
   ...
   case paraTypeSCOPE_LIST_BULLET:
      result &= gfileSetA(file, gcTypeU1, "<ul class=\"zword\">\n", NULL);
      break;

   case paraTypeSCOPE_LIST_KEY_VALUE:
      result &= gfileSetA(file, gcTypeU1, "<dl class=\"zword\">\n", NULL);
      break;

   case paraTypeSCOPE_LIST_NUMBER:
      result &= gfileSetA(file, gcTypeU1, "<ol class=\"zword\">\n", NULL);
      break;

   case paraTypeSCOPE_TABLE:
      result &= gfileSetA(file, gcTypeU1, "<table class=\"zword\"><tbody class=\"zword\">\n<tr class=\"zword\">\n", NULL);
      break;

   case paraTypeTABLE_COLUMN_HEADER:
   case paraTypeSCOPE_TABLE_COLUMN_HEADER:
      result &= gfileSetA(file, gcTypeU1, "<th class=\"zword\">",       NULL);
      break;

   case paraTypeTABLE_COLUMN_HEADER_NO_BREAK:
   case paraTypeSCOPE_TABLE_COLUMN_HEADER_NO_BREAK:
      result &= gfileSetA(file, gcTypeU1, "<th class=\"zword\"><nobr>", NULL);
      break;

   case paraTypeTABLE_COLUMN_HEADER_FILL:
   case paraTypeSCOPE_TABLE_COLUMN_HEADER_FILL:
      result &= gfileSetA(file, gcTypeU1, "<th class=\"zword_fill\">",  NULL);
      break;

   case paraTypeTABLE_COLUMN:
   case paraTypeSCOPE_TABLE_COLUMN:
      result &= gfileSetA(file, gcTypeU1, "<td class=\"zword\">",       NULL);
      break;

   case paraTypeTABLE_COLUMN_NO_BREAK:
   case paraTypeSCOPE_TABLE_COLUMN_NO_BREAK:
      result &= gfileSetA(file, gcTypeU1, "<td class=\"zword\"><nobr>", NULL);
      break;

   case paraTypeTABLE_COLUMN_FILL:
   case paraTypeSCOPE_TABLE_COLUMN_FILL:
      result &= gfileSetA(file, gcTypeU1, "<td class=\"zword_fill\">",  NULL);
      break;

   case paraTypeTABLE_COLUMN_NUMBER:
   case paraTypeSCOPE_TABLE_COLUMN_NUMBER:
      result &= gfileSetA(file, gcTypeU1, "<td class=\"zword_num\">",  NULL);
      break;

   case paraTypeTABLE_COLUMN_NUMBER_FILL:
   case paraTypeSCOPE_TABLE_COLUMN_NUMBER_FILL:
      result &= gfileSetA(file, gcTypeU1, "<td class=\"zword_num_fill\">",  NULL);
      break;

   case paraTypeTABLE_ROW:
      result &= gfileSetA(file, gcTypeU1, "<tr class=\"zword\">\n", NULL);
      break;
   }
...
static Gb _FileWriteScopeStop(Gfile * const file, ParaType const type, ParaType const parentType)
{
   ...
   case paraTypeSCOPE_ITEM:
      ...
      case paraTypeSCOPE_LIST_BULLET:
      case paraTypeSCOPE_LIST_NUMBER:
         result &= gfileSetA(file, gcTypeU1, "</li>\n", NULL);
         break;
   ...
   case paraTypeSCOPE_LIST_BULLET:
      result &= gfileSetA(file, gcTypeU1, "</ul>\n", NULL);
      break;

   case paraTypeSCOPE_LIST_KEY_VALUE:
      result &= gfileSetA(file, gcTypeU1, "</dl>\n", NULL);
      break;

   case paraTypeSCOPE_LIST_NUMBER:
      result &= gfileSetA(file, gcTypeU1, "</ol>\n", NULL);
      break;

   case paraTypeSCOPE_TABLE:
      result &= gfileSetA(file, gcTypeU1, "</tbody></table>\n", NULL);
      break;
   ...
   case paraTypeTABLE_COLUMN_HEADER_FILL:
   case paraTypeSCOPE_TABLE_COLUMN_HEADER_FILL:
      result &= gfileSetA(file, gcTypeU1, "</th>\n",       NULL);
      break;
   ...
   case paraTypeTABLE_COLUMN_NUMBER_FILL:
   case paraTypeSCOPE_TABLE_COLUMN_NUMBER_FILL:
      result &= gfileSetA(file, gcTypeU1, "</td>\n",       NULL);
      break;

   case paraTypeTABLE_ROW:
      result &= gfileSetA(file, gcTypeU1, "</tr>\n",       NULL);
      break;
   }
...
static Gb _FileWriteTitle(Gfile * const file, Para const * const para)
{
   ...
   {
      result &= gfileSetA(file, gcTypeU1, "<a name=\"", NULL);
      result &= gfileSetS(file, gcTypeU1, para->chapterStr, NULL);
      result &= gfileSetA(file, gcTypeU1, "\">", NULL);
   }
   ...
   if (paraTypeTITLE_TOC_1 <= para->type && para->type <= paraTypeTITLE_TOC_5)
   {
      result &= gfileSetA(file, gcTypeU1, "</a>", NULL);
   }
   ...
   case paraTypeTITLE_1:
   case paraTypeTITLE_TOC_1: 
      result &= gfileSetA(file, gcTypeU1, "</h1>\n", NULL);
      break;

   case paraTypeTITLE_2:
   case paraTypeTITLE_TOC_2: 
      result &= gfileSetA(file, gcTypeU1, "</h2>\n", NULL);
      break;

   case paraTypeTITLE_3:     
   case paraTypeTITLE_TOC_3: 
      result &= gfileSetA(file, gcTypeU1, "</h3>\n", NULL); 
      break;

   case paraTypeTITLE_4:     
   case paraTypeTITLE_TOC_4: 
      result &= gfileSetA(file, gcTypeU1, "</h4>\n", NULL);
      break;

   case paraTypeTITLE_5:     
   case paraTypeTITLE_TOC_5: 
      result &= gfileSetA(file, gcTypeU1, "</h5>\n", NULL);
      break;
   }
...
static Gb _FileWriteTOC(Gfile * const file, ParaArray const * const tocList)
{
   ...
   forCount (index, paraArrayGetCount(tocList))
   {
      ...
      switch (para->type)
      {
      case paraTypeTITLE_TOC_1: result &= gfileSetA(file, gcTypeU1, "<p class=\"zword_toc1\">",  NULL); break;
      case paraTypeTITLE_TOC_2: result &= gfileSetA(file, gcTypeU1, "<p class=\"zword_toc2\">",  NULL); break;
      case paraTypeTITLE_TOC_3: result &= gfileSetA(file, gcTypeU1, "<p class=\"zword_toc3\">",  NULL); break;
      case paraTypeTITLE_TOC_4: result &= gfileSetA(file, gcTypeU1, "<p class=\"zword_toc4\">",  NULL); break;
      case paraTypeTITLE_TOC_5: result &= gfileSetA(file, gcTypeU1, "<p class=\"zword_toc5\">",  NULL); break;
      }

      stemp = _ProcessInline(para->str, para);
      
      result &= gfileSetA(file, gcTypeU1, "<a href=\"#",    NULL);
      result &= gfileSetS(file, gcTypeU1, para->chapterStr, NULL);
      result &= gfileSetA(file, gcTypeU1, "\">",            NULL);
      result &= gfileSetS(file, gcTypeU1, stemp,            NULL);
      result &= gfileSetA(file, gcTypeU1, "</a></p>\n",     NULL);
