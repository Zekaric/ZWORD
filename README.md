...
rtf	Convert the zword file to an RTF file.  A zwordRTF.def file is required.
...
kv	Key-Value pair for simple two column tables.  Key and value separated by a tab.
